...
exports.createLayout = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isTypeExist) {
            return next(new ErrorHandler_1.default(`${type} already exist`, 404));
        }
        if (type === "Banner") {
        ...
        if (type === "FAQ") {
            const { faq } = req.body;
            const faqIteams = yield Promise.all(faq.map((item) => __awaiter(void 0, void 0, void 0, function* () {
                return {
                    question: item.question,
                    answer: item.answer
                };
            })));
            yield layout_model_1.default.create({ type: "FAQ", faq: faqIteams });
        }
        if (type === "Categories") {
